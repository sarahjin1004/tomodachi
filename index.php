                ...
                <div class="carousel-inner">
                    <div class="item active"> <img src="images/banner.png" style="width:100%; height: 500px" alt="First slide">
                        <div class="carousel-caption">
                            <h1>Friends</h1><br><h2>Find tomo-dachis to go to conventions with!</h2>
                        </div>
                    </div>
                    <div class="item"> <img src="images/banner2.png" style="width:100%; height: 500px" alt="Second slide">
                        <div class="carousel-caption">
                            <h1>Memories</h1><br><h2>Make everlasting friendships and memories!</h2>
                        </div>
                    </div>
                    <div class="item"> <img src="images/banner3.png" style="width:100%; height: 500px" alt="Third slide">
                        <div class="carousel-caption">
                            <h1>Adventures</h1><br><h2>Meet new faces, share interests, go have fun!</h2>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                    <div class="blog-box">
                                        <p>I met few friends here and we went to anime con together :) it was better than going alone bc I can do activities with others.</p>
                                    </div>
                                    <div class="blog-view-box">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h3 class="media-heading blog-title">Anonymous</h3>
                                                <h5 class="blog-rev">Member</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="blog-box">
                                        <p>Haven't really seen anything like this before, I like how they list all the animecons so I don't have to go search.</p>
                                    </div>
                                    <div class="blog-view-box">
                                        <div class="media">
                                            <div class="media-left">
                                ...
                                <div class="item">
                                    <div class="blog-box">
                                        <p>I still keep in touch with friends I have made here. It's amazing how people can connect through interests and can find community that loves you!</p>
                                    </div>
                                    <div class="blog-view-box">
                                        <div class="media">
                                            <div class="media-left">
